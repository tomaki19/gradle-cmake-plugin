...
public class CMakeBinaryLibraryResolverTest {
  ...
  void resolveMultipleToolchainTest() throws Exception {
    ...
    TestCMakeBinaryLibrary.register("StaticLibrary0", extension, Arrays.asList("Toolchain0"), CMakeBuildVariant.STATIC);
    TestCMakeBinaryLibrary.register("StaticLibrary1", extension, Arrays.asList("Toolchain1"), CMakeBuildVariant.STATIC);
    TestCMakeBinaryLibrary.register("SharedLibrary0", extension, Arrays.asList("Toolchain0"), CMakeBuildVariant.SHARED);
    TestCMakeBinaryLibrary.register("SharedLibrary1", extension, Arrays.asList("Toolchain1"), CMakeBuildVariant.SHARED);
    TestCMakeToolchain.registerWithLibraryDependencies("Toolchain0", extension,
        Arrays.asList(new CMakeBuildItems(CMakeVisibilityType.PUBLIC, "-loption")),
        Arrays.asList(
            new CMakeLibraryDependencies("target").from("Package0"),
            new CMakeLibraryDependencies("InterfaceLibrary0").link(CMakeLinkVariant.INTERFACE),
            new CMakeLibraryDependencies("StaticLibrary0").from(project.getName()).link(CMakeLinkVariant.STATIC),
            new CMakeLibraryDependencies("SharedLibrary0").from(project.getName()).link(CMakeLinkVariant.SHARED)));
    TestCMakeToolchain.registerWithLibraryDependencies("Toolchain1", extension,
        ...
        Arrays.asList(
            new CMakeLibraryDependencies("target").from("Package1").visibility(CMakeVisibilityType.PRIVATE),
            new CMakeLibraryDependencies("InterfaceLibrary1").from(project.getName()).link(CMakeLinkVariant.INTERFACE)
                .visibility(CMakeVisibilityType.PRIVATE),
            new CMakeLibraryDependencies("StaticLibrary1").from(project.getName()).link(CMakeLinkVariant.STATIC)
                .visibility(CMakeVisibilityType.PRIVATE),
            new CMakeLibraryDependencies("SharedLibrary1").from(project.getName()).link(CMakeLinkVariant.SHARED)
                .visibility(CMakeVisibilityType.PRIVATE)));
    ...
    assertEquals(0, toolchains[0].getTests().size());
    {
      final CMakeResolvedLibrary[] interfaceLibrary = toolchains[0].getInterfaceLibraries()
          .toArray(new CMakeResolvedLibrary[toolchains[0].getInterfaceLibraries().size()]);
    ...
    assertEquals(0, toolchains[1].getTests().size());
    {
      final CMakeResolvedLibrary[] interfaceLibrary = toolchains[1].getInterfaceLibraries()
          .toArray(new CMakeResolvedLibrary[toolchains[1].getInterfaceLibraries().size()]);
      assertEquals("InterfaceLibrary0", interfaceLibrary[0].getName());
  ...
  void resolveNoDependenciesTest() throws Exception {
    ...
    TestCMakePackage.register("Package0", extension);
    TestCMakeBinaryLibrary.register("BinaryLibrary0", extension, Arrays.asList("Toolchain0"), CMakeBuildVariant.SHARED);
    TestCMakeToolchain.register("Toolchain0", extension);
    TestCMakeBinaryLibrary.register("BinaryLibrary1", extension, Arrays.asList("Toolchain0"), CMakeBuildVariant.SHARED);
    ...
    TestCMakeToolchain.registerWithLibraryDependencies("Toolchain0", extension,
        ...
        Arrays.asList(
            ...
            new CMakeLibraryDependencies("InterfaceLibrary0")
                .link(CMakeLinkVariant.INTERFACE)
                .forBuildVariant(CMakeBuildVariant.SHARED),
