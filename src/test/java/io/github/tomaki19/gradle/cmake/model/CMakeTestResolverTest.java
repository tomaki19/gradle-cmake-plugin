    ...
    void resolveNoToolchainTest() throws Exception {
        ...
        TestCMakeToolchain.registerWithApplicationDependencies("Toolchain0", extension,
                ...
                Arrays.asList(
                        ...
                        new CMakeExecutableDependencies("InterfaceLibrary0").link(CMakeLinkVariant.INTERFACE),
                        new CMakeExecutableDependencies("BinaryLibrary0")
                                .from(project.getName()).link(CMakeLinkVariant.SHARED)));
    ...
    void resolveMultipleToolchainTest() throws Exception {
        ...
        TestCMakeToolchain.registerWithTestDependencies("Toolchain0", extension,
                ...
                Arrays.asList(
                        ...
                        new CMakeExecutableDependencies("InterfaceLibrary0").link(CMakeLinkVariant.INTERFACE)
                                .visibility(CMakeVisibilityType.PUBLIC),
                        new CMakeExecutableDependencies("BinaryLibrary0").from(project.getName())
        ...
        TestCMakeToolchain.registerWithTestDependencies("Toolchain0", extension,
                ...
                Arrays.asList(
                        ...
                        new CMakeExecutableDependencies("InterfaceLibrary0")
                                .from(project.getName()).link(CMakeLinkVariant.INTERFACE),
                        new CMakeExecutableDependencies("BinaryLibrary0").link(CMakeLinkVariant.SHARED)));
        TestCMakeTest.register("Test0", extension,
                Arrays.asList("Toolchain0"));
