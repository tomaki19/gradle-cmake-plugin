...
class CMakeModuleFileTest {
  ...
  /**
   * Covers buildModel(): library.getLinkVariant() == CMakeLinkVariant.SHARED
   * branch (true),
   * operatingSystem.isLinux() branch (true on Linux), operatingSystem.isWindows()
   * branch (false on Linux).
   */
  @Test
  ...
  /**
   * Covers buildModel(): library.getLinkVariant() == CMakeLinkVariant.STATIC
   * branch (true).
   */
  @Test
  ...
  /**
   * Covers buildModel(): for loops for allProjectDependencies,
   * publicProjectDepTargets,
